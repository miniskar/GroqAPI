...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="poll interval for fault monitoring",
    )
    parser.add_argument(
        "--file",
        type=str,
        default="c2c_link_faults.log",
        help="path/filename to save the faults being polled\n",
    )
    parser.add_argument(
        "--speed",
        type=float,
    ...
    try:
        # Enable the link fault monitoring on the topology
        thread = tsp.enable_topology_link_fault_monitoring(
            args.poll_interval, args.file
        )
    ...
    try:
        ...
        print_utils.infoc("Disabling the fault monitoring")
        tsp.disable_topology_link_fault_monitoring()
